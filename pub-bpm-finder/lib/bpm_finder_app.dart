library bpm_finder_app;

class BpmFinder {
  static double calculateBpm(List<double> tapTimestampsMs) {
    if (tapTimestampsMs.length < 2) return 0.0;
  ...
  static double calculateDelayMs(double bpm, String noteDivision) {
    if (bpm <= 0) return 0.0;
    ...
    switch (noteDivision.toLowerCase()) {
      case '1/4':
        return quarterMs;
      case '1/8':
        return quarterMs / 2.0;
      case '1/8d':
        return (quarterMs / 2.0) * 1.5;
      case '1/16':
        return quarterMs / 4.0;
      case 'triplet':
        return quarterMs / 3.0;
      default:
        return quarterMs;
    }
  }
